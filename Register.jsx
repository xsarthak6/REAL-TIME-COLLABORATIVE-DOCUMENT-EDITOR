...
const styles = {
  ...
  title: { fontSize: '22px', fontWeight: '600', marginBottom: '6px', color: 'var(--text)' },
  subtitle: { fontSize: '14px', color: 'var(--text2)', marginBottom: '24px' },
  switchText: { textAlign: 'center', fontSize: '13px', color: 'var(--text2)', marginTop: '20px' },
};
